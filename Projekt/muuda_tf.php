<?php
    ...
    $query1 = "SELECT Tahmafilter FROM rpurge_autod WHERE ID='$id'";
    ...
    $query ="UPDATE rpurge_autod SET Tahmafiltri_hooldus='$uusnait' WHERE ID='$id'";
    mysqli_query($connection, $query) or die("$query - ".mysqli_error($connection));
    header("Location: vaata.php");
    }
?>
<script>
alert("Sellel autol pole tahmafiltrit! Andmeid ei muudetud...")
